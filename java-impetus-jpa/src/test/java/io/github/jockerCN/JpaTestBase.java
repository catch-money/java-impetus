...
public class JpaTestBase {
    ...
    static void dynamicProperties(DynamicPropertyRegistry registry) {
        // 数据源配置
        registry.add("spring.datasource.url", () -> "jdbc:mysql://192.168.1.129:3306/jpa?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&verifyServerCertificate=false&useSSL=false&allowPublicKeyRetrieval=true");
        ...
        registry.add("spring.datasource.hikari.pool-name", () -> "suwdm_mysql_pool");
